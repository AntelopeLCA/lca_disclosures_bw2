...
for dirpath, dirnames, filenames in os.walk('lca_disclosures_bw2'):
...
setup(
    name='lca_disclosures_bw2',
    version="0.1.0",
    packages=packages,
    author="P. James Joyce",
    author_email="pjamesjoyce@gmail.com",
    license=open('LICENSE').read(),
    package_data={'lca_disclosures_bw2': my_package_files},
    #entry_points = {
    #   'console_scripts': [
    #   ]
    #},
    ...
    url="https://github.com/AntelopeLCA/lca_disclosures_bw2/",
    long_description=open('README.md').read(),
    description='Python based tools for working with LCA foreground model disclosures in Brightway2',
